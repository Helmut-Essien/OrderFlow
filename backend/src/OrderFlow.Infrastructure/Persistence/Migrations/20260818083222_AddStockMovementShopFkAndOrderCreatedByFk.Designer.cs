...
namespace OrderFlow.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260818083222_AddStockMovementShopFkAndOrderCreatedByFk")]
    partial class AddStockMovementShopFkAndOrderCreatedByFk
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OrderFlow.Domain.Entities.StockMovement", b =>
                {
                    ...
                    b.HasOne("OrderFlow.Domain.Entities.Shop", null)
                        .WithMany()
                        .HasForeignKey("ShopId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
